...
let selColours = ['groen', 'blauw', 'rood']
let last = selColours[selColours.length - 1]
selColours.push('geel');
selColours.push('5');
selColours.push({ greeting: "hi ik ben een object" });
console.log(selColours);
console.log(selColours.length);
console.log(selColours[0]);
console.log(last);
